...
function Fullshirt(props) {
  ...
  useEffect(() => {
     ...
     * if loading is true then loads button with loading... text
     * then sets loading to false
     *
     */
      ...
      <div id="right">
        <div className="side-by-side">
          ...
          <div className="cart-checkout">
            <h1>
              <span className="h1-brand">{props.label.design}</span>
              <span className="h1-item">{props.label.itemname}</span>
            </h1>
            ...
            <Stack
              style={{ width: "30%", textAlign: "centre" }}
              direction="vertical"
              gap={1}
            >
...
{props.label.size.map((el)=>{
  ...
  <option value={el}>{el}</option>
            ...
            <div style={{ margin: "40px 0" }} className="d-grid gap-2">
              ...
              >
                {loading && size ? "Adding…" : "Add to Basket"}
              </Button>
            </div>
            ...
            >
              {props.cartItems === 0
                ? ""
                : props.cartItems === 1
                ? `You have ${props.cartItems} item in your basket:`
                : `You have ${props.cartItems} items in your basket:`}
            </p>
...
<Button variant="outline-secondary" size="lg"  >Continue shopping</Button></div> */}
            <div style={{ height: "200px", marginTop: "50px" }}>
              ...
              >
                ...
                <Tab eventKey="Returns" title="Returns">
                  <p>
                    You can now return your online order in a few easy
                    steps.Select your preferred tracked returns service. We have
                    print at home, paperless and collection options available.
                    You have 28 days to return your order from the date it’s
                    delivered. Exclusions apply.
                  </p>
                </Tab>
        ...
        <div className="random-selection">
          <Selection label={props.labelselect} action={props.action1} />
        </div>
      </div>
      <Footer />
    </>
